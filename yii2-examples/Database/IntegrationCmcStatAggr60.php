...
/**
 * This is the model class for table "{{%integration_cmc_stat_aggr60}}".
 *
 * @property integer $id
 ...
 */
class IntegrationCmcStatAggr60 extends \App\Components\BaseModel
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%integration_cmc_stat_aggr60}}';
    }
